...
import { Download, ImageIcon, Video, X, ArrowLeft } from "lucide-react"
...
import { getPreset, buildLayersFromPreset } from "@/lib/presets"
import { DEFAULT_CANVAS, type CanvasSettings, type MediaSource } from "@/lib/renderer"

export function Editor({ presetId }: { presetId?: string }) {
  const preset = getPreset(presetId)

  const [layers, setLayers] = useState<ShaderLayer[]>(() =>
    preset ? buildLayersFromPreset(preset) : [createLayer("dither")],
  )
